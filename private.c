...
XS(_wrap_get_bidi_type) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj((FriBidiCharType *)memcpy((FriBidiCharType *)malloc(sizeof(FriBidiCharType)),&result,sizeof(FriBidiCharType)), SWIGTYPE_p_fribidi_uint32, SWIG_POINTER_OWN | 0); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_get_bidi_type_name) {
  {
    ...
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_fribidi_uint32,  0 );
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_bidi_type_name" "', argument " "1"" of type '" "FriBidiCharType""'"); 
      }  
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "get_bidi_type_name" "', argument " "1"" of type '" "FriBidiCharType""'");
      } else {
...
XS(_wrap_get_joining_type) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj((FriBidiJoiningType *)memcpy((FriBidiJoiningType *)malloc(sizeof(FriBidiJoiningType)),&result,sizeof(FriBidiJoiningType)), SWIGTYPE_p_fribidi_uint8, SWIG_POINTER_OWN | 0); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_get_joining_type_name) {
  {
    ...
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_fribidi_uint8,  0 );
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_joining_type_name" "', argument " "1"" of type '" "FriBidiJoiningType""'"); 
      }  
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "get_joining_type_name" "', argument " "1"" of type '" "FriBidiJoiningType""'");
      } else {
        arg1 = *((FriBidiJoiningType *)(argp1));
      }
    }
